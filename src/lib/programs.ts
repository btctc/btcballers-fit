...
export const fallSeason = {
  ...
  schedule: [
    { day: "Tuesdays", time: "4:45P - 6:30P", where: "Home court" },
    { day: "Wednesdays", time: "4:00P - 5:45P", where: "Home court" },
    { day: "Thursdays", time: "4:45P - 6:30P", where: "Home court" },
...
export const fallSessions: FallSession[] = [
  { key: "2026-08-20", dateKey: "2026-08-20", label: "Thu, Aug 20", time: "4:45P - 6:30P", where: "Home court" },
  ...
  { key: "2026-09-01", dateKey: "2026-09-01", label: "Tue, Sep 1", time: "4:45P - 6:30P", where: "Home court" },
  { key: "2026-09-08", dateKey: "2026-09-08", label: "Tue, Sep 8", time: "4:45P - 6:30P", where: "Home court" },
  { key: "2026-09-10", dateKey: "2026-09-10", label: "Thu, Sep 10", time: "4:45P - 6:30P", where: "Home court" },
  ...
  { key: "2026-09-17", dateKey: "2026-09-17", label: "Thu, Sep 17", time: "4:45P - 6:30P", where: "Home court" },
  { key: "2026-09-18", dateKey: "2026-09-18", label: "Fri, Sep 18", time: "4:00P - 9:00P", where: "Home court", mm: true },
  { key: "2026-09-22", dateKey: "2026-09-22", label: "Tue, Sep 22", time: "4:45P - 6:30P", where: "Home court" },
  { key: "2026-09-23", dateKey: "2026-09-23", label: "Wed, Sep 23", time: "4:00P - 5:45P", where: "Home court" },
  { key: "2026-09-24", dateKey: "2026-09-24", label: "Thu, Sep 24", time: "4:45P - 6:30P", where: "Home court" },
  { key: "2026-09-26", dateKey: "2026-09-26", label: "Sat, Sep 26", time: "10:00A - 11:45A", where: "Home court" },
  { key: "2026-10-06", dateKey: "2026-10-06", label: "Tue, Oct 6", time: "4:45P - 6:30P", where: "Home court" },
  ...
  { key: "2026-10-20", dateKey: "2026-10-20", label: "Tue, Oct 20", time: "4:45P - 6:30P", where: "Home court" },
  { key: "2026-10-22", dateKey: "2026-10-22", label: "Thu, Oct 22", time: "4:45P - 6:30P", where: "Home court" },
  { key: "2026-10-27", dateKey: "2026-10-27", label: "Tue, Oct 27", time: "4:45P - 6:30P", where: "Home court" },
  ...
  { key: "2026-11-03", dateKey: "2026-11-03", label: "Tue, Nov 3", time: "4:45P - 6:30P", where: "Home court" },
  { key: "2026-11-11", dateKey: "2026-11-11", label: "Wed, Nov 11", time: "4:00P - 5:45P", where: "Home court" },
  { key: "2026-11-12", dateKey: "2026-11-12", label: "Thu, Nov 12", time: "4:45P - 6:30P", where: "Home court" },
  { key: "2026-11-13", dateKey: "2026-11-13", label: "Fri, Nov 13", time: "4:00P - 9:00P", where: "Home court", mm: true },
  { key: "2026-11-17", dateKey: "2026-11-17", label: "Tue, Nov 17", time: "4:45P - 6:30P", where: "Home court" },
  { key: "2026-11-19", dateKey: "2026-11-19", label: "Thu, Nov 19", time: "4:45P - 6:30P", where: "Home court" },
